    ...
    return (
        <div className="min-h-screen bg-gray-950 text-white">
            ...
            <div className="px-12 py-12">
                <h2 className="text-3xl font-bold mb-1">Search History</h2>
                ...
                <div className="flex flex-col gap-4">
                    {history.map((item) => (
                        <div key={item.id} className="bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-emerald-700 transition">
                            <h3 className="text-white font-semibold mb-4">{item.address}</h3>
                            ...
                            <p className="text-gray-600 text-xs">{new Date(item.searchedAt).toLocaleString()}</p>
                        </div>
                    ))}
                </div>
            </div>
