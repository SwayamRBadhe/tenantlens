    ...
    return (
        <div className="min-h-screen bg-gray-950 text-white">
            ...
            <div className="px-12 py-12 max-w-3xl">
                <h2 className="text-3xl font-bold mb-2">Analyze a Property</h2>
                ...
                {result && (
                    <div className="bg-gray-900 border border-gray-800 rounded-xl p-6">
                        <h3 className="text-xl font-bold mb-6 text-blue-400">{result.address}</h3>

                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                            <div className="text-center">
                                <p className="text-gray-400 text-sm mb-1">Safety</p>
                                <p className={`text-2xl font-bold ${getScoreColor(result.safetyScore)}`}>{result.safetyScore}/10</p>
                            </div>
                            <div className="text-center">
                                <p className="text-gray-400 text-sm mb-1">Reviews</p>
                                <p className={`text-2xl font-bold ${getScoreColor(result.reviewScore)}`}>{result.reviewScore}/10</p>
                            </div>
                            <div className="text-center">
                                <p className="text-gray-400 text-sm mb-1">Rent</p>
                                <p className={`text-2xl font-bold ${getScoreColor(result.rentScore)}`}>{result.rentScore}/10</p>
                            </div>
                            <div className="text-center">
                                <p className="text-gray-400 text-sm mb-1">Overall</p>
                                <p className={`text-2xl font-bold ${getScoreColor(result.overallScore)}`}>{result.overallScore}/10</p>
                            </div>
                        </div>

                        <div className="border-t border-gray-800 pt-4">
                            <h4 className="text-gray-400 text-sm mb-2">AI Report</h4>
